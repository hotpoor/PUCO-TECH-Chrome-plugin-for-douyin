...
$ ->
    console.log "bitfeg_v2"
    $("body").on "click",".tab_btn",(evt)->
        dom_name = $(this).attr("data-name")
        $(".tab_btn").removeClass("current")
        $(this).addClass("current")
        $(".tab_main_area").addClass("hide")
        $(".tab_main_area[data-name=#{dom_name}]").removeClass("hide")
    $("body").on "click",".abc",(evt)->
        $("body").width(800)
    $("body").on "click",".cba",(evt)->
        $("body").width(360)
    ...
    chart = LightweightCharts.createChart($("#tv_chart_container")[0], chart_style)
    lineSeries = chart.addLineSeries()
    lineSeries.setData([
        { time: '2019-04-11', value: 58.00 },
        { time: '2019-04-12', value: 58.00 },
        { time: '2019-04-13', value: 57.00 },
        { time: '2019-05-17', value: 57.06 },
        { time: '2019-05-20', value: 59.15 },
        { time: '2019-05-21', value: 59.10 },
        { time: '2019-05-22', value: 59.09 },
        { time: '2019-05-23', value: 59.00 },
        { time: '2019-05-24', value: 59.07 },
        { time: '2019-05-28', value: 59.21 },
    ])
    areaSeries = chart.addAreaSeries({
        topColor: 'rgba(38,198,218, 0.36)',
        bottomColor: 'rgba(38,198,218, 0.00)',
        lineColor: 'rgba(38,198,218, 0.5)',
        lineWidth: 2,
    });
